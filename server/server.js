...
import { registerOwnerAuthRoutes } from './routes/owner-auth-routes.js';
...
app.post('/api/team/tasks/:id/approve', async (req, res) => {
  try {
    const result = await teamWorkspace.approveWorkItem(parseInt(req.params.id));
