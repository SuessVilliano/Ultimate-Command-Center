...
export default function AffiliateHub(props) {
  ...
  return (
    <div className="space-y-5">
      <LiveAffiliateCrmSync isDark={props.isDark !== false} />
      ...
      <section className="rounded-2xl border border-white/10 bg-white/[0.02] p-3">
        ...
        >
          <div>
            ...
            <div className="mt-0.5 text-xs text-slate-500">Weekly-import analytics remain here; live contact data, notes and activity above are authoritative.</div>
          </div>
