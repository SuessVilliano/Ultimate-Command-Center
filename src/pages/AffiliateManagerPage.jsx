...
import { Briefcase, ExternalLink, Target, Users, TrendingUp, CalendarDays, BookOpen } from 'lucide-react';
...
export default function AffiliateManagerPage(){return <div className="space-y-5">
 <section className="rounded-2xl border border-cyan-500/20 bg-gradient-to-br from-cyan-950/20 via-[#0b0d12] to-purple-950/20 p-5"><div className="flex items-center gap-3"><div className="w-11 h-11 rounded-xl bg-cyan-500/15 grid place-items-center"><Briefcase className="w-5 h-5 text-cyan-300"/></div><div><div className="text-xs uppercase tracking-[.18em] text-cyan-300">GoHighLevel career</div><h1 className="text-2xl font-bold text-white">Affiliate Manager OS</h1><p className="text-sm text-gray-500 mt-1">Customer Support Specialist / Freshdesk is legacy. Active work is partner growth, affiliate portfolio management, enablement, product mastery, reporting, events and relationship development.</p></div></div>
