...
printf '\n✅ LIV8 CLI installed\n'
printf 'Commands:\n'
printf '  liv8                Open Morning Command (Command Center first)\n'
printf '  liv8 --update       Update Command Center, then open Morning Command\n'
printf '  liv8-start          Start/check the whole LIV8 stack\n'
printf '  liv8-start --update Pull the three repos before starting\n'
printf '  liv8-start --no-obs Start full stack without opening OBS Studio\n'
